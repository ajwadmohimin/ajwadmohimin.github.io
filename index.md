...
or code-blocks `inline` or with highlighting (note the `@def hascode = true` in the source to [allow](#how_to_use_franklin) [highlight.js](https://highlightjs.org/) to do its job):
